            ...
            <div className="projects">
                ...
                <div className="description">
                    <p id="para1">
                        ...
                        <p className="shortText" lang="en">Mocny i ekologiczny - taki jest właśnie LEM SSV. Zespół LEM Wrocław po raz pierwszy stworzył terenowy pojazd czterokołowy, będący wizją przyszłości zeroemisyjnych Rajdów Dakar. Proces twórczy przy zasadach zero waste, a efekt końcowy dający potężną dawkę emocji. Czy może być lepiej?</p>  
                    </p>
                    <p id="para2">
                        <h4>PREVIOUS PROJECT</h4>
                        <h1>PHOTON SPEED<br/>AND POWER</h1>
                        <p className="shortText" lang="en">Podbił hiszpański MotorLand Aragón, a na koncie ma już podium na torze F1 we Włoszech. To jednak możliwe, że studencki prototyp wyciąga nawet 200km/h. Poznaj innowacyjny projekt LEM Photon - pierwszy polski elektryczny motocykl szosowy zbudowany w pełni przez studentów Politechniki Wrocławskiej. </p>  
                    </p>
                </div>
                <ChangePicture />
            </div>
